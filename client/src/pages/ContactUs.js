  ...
  return (
        ...
        <div className="my-6">
            ...
            <img src={Img1} alt="Background" className='item-center
             mt-3'/>
               <button className='bg-gradient-to-r from-orange-600 to-orange-400 border-2 border-orange-600 rounded-full mt-4 px-4 py-2 text-white hover:scale-105 duration-200'>Contact Us</button>
          </div>
          <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
            <div>
              <h1 className="text-3xl font-extrabold">Let's Talk</h1>
              <p className="text-sm text-gray-400 mt-3">Have a big idea or brand to develop and need help? Reach out - we'd love to hear about your project and provide assistance.</p>
              <div className="mt-12">
