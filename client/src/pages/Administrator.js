    ...
    <div className="min-h-screen bg-blue-300 flex">
      <aside className="w-64 bg-blue-900 p-4">
        ...
        <nav>
          ...
          <a href="#" className="block py-3.5 px-4 rounded hover:bg-orange-500 hover:text-black" onClick={toggleDialog}> Event Form</a>
          ...
          <a href="#" className="block py-3.5 px-4 rounded hover:bg-orange-500 hover:text-black">Contact Notifications</a>
        </nav>
      </aside>
      {isDialogOpen && (
        <div
      ...
      <main className="flex-1 p-6">
        ...
        <h1 className='text-5xl text-center mb-4 font-bold'> Dashboard of <span className='text-blue-900'>Administrators</span></h1>
              ...
              <tr key={index}>
                <td className="py-2 px-4 border-b">
                  <div className="flex items-center">
                    <img src={`https://i.pravatar.cc/40?img=${index+1}`} alt={client.name} className="rounded-full w-10 h-10 mr-3" />
                    <div>
                ...
                <td className="py-2 px-4 border-b">
                  <span className={`px-2 py-1 text-black rounded text-sm ${client.status === "Active" ? "bg-green-600 text-white" : client.status === "Offline" ? "bg-red-500 text-white" : "bg-green-500 text-white"}`}>{client.status}</span>
                </td>
